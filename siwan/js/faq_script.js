...
**Q1. 我一定得修〈中文思辨與表達〉嗎？有其他選擇嗎？**
A：
*   **110學年度(含)以前入學：** 必須修畢〈中文思辨與表達〉(一)及(二)兩門課。
*   **111至113學年度入學：** 〈中文思辨與表達〉(一)或(二)「兩門擇一即可」，修過任何一門就算完成中文必修3學分。
*   **114學年度入學：** 原則上修習〈中文思辨與表達〉(一)或(二)擇一。但若修畢《國家語言發展法》界定之語言課程 3 學分，得申請抵免此必修。
*   **115學年度(含)以後入學：** 必修調整為「國家語言」3學分。您可直接選擇修習「中文思辨與表達」或「本土語言」課程來滿足此要求。

**Q2. 全英語專班的學生也需要修〈中文思辨與表達〉課程嗎？**
A：是的，全英語專班學生仍須依通識教育架構規定修習〈中文思辨與表達〉（或115學年度起之「國家語言」）課程。若為外籍生或僑生，如中文能力不足，可依規定申請以「華語教學中心課程」抵免。此外，外籍、僑外及凡於高級中等教育階段修業，以非中文為主要授課語言者（例如修習國際文憑課程〔International Baccalaureate, IB〕、自學符合同等學力、於外僑學校或國外高中畢業者）身份之學位生修習跨院選修(通)「閱讀中華寶島」課程通過後，也可申請抵免。所有抵免仍須符合相關時數及成績規定。

**Q3. 拿到本土語言中級以上證照，可以抵免哪些課？**
A：
*   **111-114學年度入學：** 可持本土語言（閩南語、客語及原住民語）及臺灣手語中級以上證照，折抵「跨院選修」至多2學分。
*   **114學年度入學：** 除上述證照抵免跨院選修外，若實際修習《國家語言發展法》界定之語言課程3學分，可抵免「中文思辨與表達」。
*   **115學年度(含)以後入學：** 「本土語言」已正式納入「國家語言」必修類別。您可以直接修習本土語言課程來完成「國家語言」的3學分必修要求。而證照抵免跨院選修的規定（至多2學分）依然適用。
...
**Q25. 博雅課程的學分有抵免上限嗎？**
A：是的。
*   從外校轉學進入本校的學生或經本校核准出國研修或修讀雙聯學位者：博雅課程學分抵免上限為6學分。
*   本校學生轉系：博雅課程學分抵免上限最多為12學分。
*   抵免的課程原則上需為近4年內本校曾開設過的課程。
...
A：「大學之道」的講座或活動場次皆會公告於西灣學院的官方網站，請定期上網查詢。聽講時，請務必主辦單位規定進行簽到、退，以確實記錄出席。
...
**Q32. 大一新生可以修服務學習課程嗎？**
A：114-2學期起服務學習課程大一（含）以上學生可以修習。未修習過服務學習課程之學生，可以透過參與期末的服務學習成果海報展或成果發表影片，來了解學校開設的服務學習課程內容。
...
A：是的，運動與健康課程為必修，分為大一體適能、游泳各1學分，及「其他必修之運動與健康課程」2 學分，總共4學分。這4學分一律「不列入」各學系的最低畢業學分計算中，但其成績仍會計算在學期平均成績內。

**Q35. 體育課選課上有年級限制嗎？**
A：每一年級最高只能修習該年級課程
*   大一不能修習大二、大三課程
*   大二不能修習大三課程
*   大三及大四學生可以補修先前未完成的體育必修課程。
...
A：可以。學校會在開學後辦理游泳會考（通常標準為50公尺蛙式），詳細的會考時間請留意西灣學院網站的公告。通過抵免學生名單會由中心統一送至教務處登錄系統，如當學期期末成績沒有顯示游泳TR，請盡快與中心確認。
...
A：原則上，所有學生的通識教育課程規定，都是以其「入學學年度」的規則為準。若有特殊情況（例如因延畢而跨越了新舊學制交替期），建議主動向西灣學院或教務處註冊組提出個案審議。
